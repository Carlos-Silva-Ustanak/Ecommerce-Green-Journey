            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
                <div class="p-6">
                    <div class="text-center">
                        <h1 class="text-2xl font-bold text-gray-800">Cadastrar-se</h1>
                    ...
                    <form wire:submit.prevent='save'>
                        <div class="grid gap-y-4">
                            <!-- Grupo de Formulário -->
                            <div>
                                <label for="name" class="block text-sm mb-2 text-gray-800">Nome</label>
                                <div class="relative">
                            ...
                            <button type="submit"
                                class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-green-600 text-white hover:bg-green-700 disabled:opacity-50 disabled:pointer-events-none">Cadastrar-se</button>
                        </div>
                    </form>
                    <!-- Fim do Formulário -->
                </div>
