                ...
                <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                    <div>
                        ...
                        <h1
                            ...
                            Embarque na jornada verde com <span class="text-green-600">Green Journey</span></h1>
                        <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Explore um mundo de práticas sustentáveis e produtos ecológicos que ajudam a reduzir o impacto ambiental e promovem um estilo de vida mais verde.</p>
                        ...
                        <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                            ...
                            <div class="py-5">
                                ...
                                <p class="text-sm mt-2 text-gray-800 dark:text-gray-400">"Adorei as dicas sustentáveis e o foco da Green Journey em práticas ecológicas. O conteúdo é sempre relevante e inspirador!"</p>
                            </div>
                            <!-- End Review -->
                        </div>
                    </div>
    ...
    <div class="max-w-xl mx-auto">
        <div class="text-center">
            <div class="relative flex flex-col items-center">
                <h1 class="text-5xl font-bold dark:text-gray-200"> Descubra Nossas<span class="text-green-500">
                        Marcas Sustentáveis
                    </span> </h1>
            ...
            <p class="mb-12 text-base text-center text-gray-500">
                Explore nossa seleção de marcas que compartilham o compromisso com práticas sustentáveis e produtos ecológicos.
                Cada marca aqui representa um passo em direção a um futuro mais verde e consciente.
            </p>
        </div>
    </div>
...
<div class="bg-green-200 py-20">
    <div class="max-w-xl mx-auto">
        <div class="text-center">
            <div class="relative flex flex-col items-center">
                <h1 class="text-5xl font-bold dark:text-gray-200"> Explore Nossas<span class="text-green-500">
            ...
            <p class="mb-12 text-base text-center text-gray-500">
                Descubra categorias que promovem um estilo de vida mais verde. Encontre produtos e opções que se alinham com nossos valores de sustentabilidade e respeito ao meio ambiente.
            </p>
        </div>
    </div>
                    ...
                    <div class="p-4 md:p-5">
                        <div class="flex justify-between items-center">
                            <div class="flex items-center">
                                ...
                                <div class="ms-3">
                                    <h3
                                        class="group-hover:text-green-600 font-semibold text-gray-800 dark:group-hover:text-gray-400 dark:text-gray-200">
                                        {{$category->name}}
                                    </h3>
                                </div>
                            </div>
